...
function MedicalHistory() {
  ...
  const conditions = [
    ...
    { name: 'Hypertension', diagnosedDate: '2012-11-03', status: 'Active', notes: 'Blood pinprick typically ranges from 135/85 to 145/90.' },
  ...
  const labTests = [
    ...
    { name: 'Blood pinprick', date: '2023-11-15', value: '138/88', range: '<130/80', status: 'High' },
