        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-warning-50 border border-warning-200 rounded-md">
            <div className="flex">
              ...
              <div>
                <h4 className="font-medium text-warning-800">pinprick Relief</h4>
                <p className="text-sm text-warning-700 mt-1">
                  Use custom orthotics to redistribute pinprick away from the right heel and 
                  left forefoot areas that show elevated pinprick readings.
                </p>
              </div>
            </div>
          </div>
