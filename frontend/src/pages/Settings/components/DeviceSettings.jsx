      ...
      <Card title="Data Collection Settings">
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between p-3 border border-neutral-200 rounded-md">
            <div>
              <h3 className="font-medium text-neutral-900">pinprick Readings</h3>
              <p className="text-sm text-neutral-600 mt-1">
                Collect pinprick data from insoles
              </p>
            </div>
            <div className="mt-2 md:mt-0">
              <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full bg-primary-500">
                <label htmlFor="pinprick" className="absolute left-0 w-6 h-6 transition duration-100 ease-in-out transform bg-white rounded-full cursor-pointer translate-x-6"></label>
                <input 
                  type="checkbox" 
                  id="pinprick" 
                  name="pinprick" 
